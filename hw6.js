...
for (let i = 0; i < 10; i++) {
    ...
    if (randomArr[i] % 2 === 0) {
       randomArr1.push(randomArr[i]); 
    }    
}
console.log(`Исходный массив: ${randomArr}`);
console.log(`Массив с четными числами: ${randomArr1}`);
...
for (let i = 0; i < 6; i++) {
    randomArr1.push(randomArr());    
}

console.log(randomArr1);

const sum = randomArr1.reduce((a, b) => a + b, 0);

console.log(`Среднеарифметическое равно: ${Math.floor(sum / randomArr1.length)}`);
